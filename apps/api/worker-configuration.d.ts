/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 9782261d1f2463adbe8ace2b3809cd20)
// Runtime types generated with workerd@1.20250416.0 2025-04-28 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SITES: KVNamespace;
		LOGS: KVNamespace;
		AZURE_STORAGE_QUEUE_SAS_URL: string;
		NODE_ENV: string;
		CONTROL_PANE_URL: string;
		API_SIDECAR_KEY: string;
		...
		LOGGER: DurableObjectNamespace<import("./src/index").DurableLogger>;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AZURE_STORAGE_QUEUE_SAS_URL" | "NODE_ENV" | "CONTROL_PANE_URL" | "API_SIDECAR_KEY" | "CLOUDFLARE_EMAIL" | "CLOUDFLARE_API_KEY" | "CLOUDFLARE_ZONE_ID" | "POSTHOG_TOKEN" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GITHUB_WEBHOOK_SECRET" | "GITHUB_PRIVATE_KEY">> {}
}
